<div class="mt-8 space-y-2">
    ...
    <div class="bg-white shadow rounded-lg p-4">
        ...
        <div class="space-y-2">
            ...
            <input class="w-full px-4 py-2 border rounded-lg" type="text" id="name" placeholder="Masukkan nama" name="nis" readonly>
        </div>
        <div class="space-y-2">
            <label class="block font-bold" for="nis">NIS</label>
            <input class="w-full px-4 py-2 border rounded-lg" type="text" id="nis" placeholder="Masukkan NIS" name="name" readonly>
        </div>
        <div class="space-y-2">
